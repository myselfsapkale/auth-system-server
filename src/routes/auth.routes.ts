...
import { register, sign_in, access_token_from_refresh_token, sign_out, sign_out_all, forget_password, verify_forget_password_otp, change_password_with_secret, sso_sign_in_token_send_google, insert_permissions } from '../controller/auth.controller';
...
router.route('/insert_permissions').post(insert_permissions);
